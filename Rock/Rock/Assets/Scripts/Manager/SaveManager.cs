...
public class SaveManager : MonoBehaviour
{
    ...
    public void Save()
    {
        ...
        QuickSaveWriter.Create("Inventory17")
    ...
    public void Load()
    {
...
#if UNITY_ANDROID
        string saveFilePath = Path.Combine(Application.persistentDataPath, @"QuickSave/Inventory17.json");
        ...
        {
            QuickSaveReader.Create("Inventory17")
