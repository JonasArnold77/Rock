...
public class SaveManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        LevelManager.Instance.actualChunkType = LevelManager.Instance.ChunkTypeDb.Saw;
    ...
    public void Save()
    {
        ...
        QuickSaveWriter.Create("Inventory77", settings)
    ...
    public void Load()
    {
...
#if UNITY_ANDROID
        string saveFilePath = Path.Combine(Application.persistentDataPath, @"QuickSave/Inventory77.json");
        ...
        {
            QuickSaveReader.Create("Inventory77", settings)
    ...
    private void SetDefaultValues()
    {
        ...
        foreach (var c in Challenges)
        {
            CameraChallengesStrings.Add(ChallengeManager.Instance.CreateWholeSaveString(c,"Normal", new int[] { 0, 0, 0, 0 }));
        }
