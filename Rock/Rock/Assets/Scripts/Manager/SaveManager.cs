...
public class SaveManager : MonoBehaviour
{
    ...
    public void Save()
    {
        ...
        QuickSaveWriter.Create("Inventory30")
    ...
    public void Load()
    {
...
#if UNITY_ANDROID
        string saveFilePath = Path.Combine(Application.persistentDataPath, @"QuickSave/Inventory30.json");
        ...
        {
            QuickSaveReader.Create("Inventory30")
